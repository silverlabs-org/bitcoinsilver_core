...
# The block reward of coinbaseoutput.nValue (50) BTCS/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTCS/block.
...
class TestBitcoin_SilverCli(Bitcoin_SilverTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoin_silver-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitcoin_silver-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BTCS) to the default wallet.
            ...
            # Test bitcoin_silver-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoin_silver-cli -generate with -rpcwallet in multiwallet mode.
