...
# TestP2PConn: A peer we use to send messages to bitcoin_silverd, and store responses.
...
class CompactBlocksTest(Bitcoin_SilverTestFramework):
    ...
    # This test actually causes bitcoin_silverd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoin_silverd's choice of nonce.
    ...
    # Test that bitcoin_silverd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoin_silverd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitcoin_silverd will not send blocktxn responses for blocks whose height is
