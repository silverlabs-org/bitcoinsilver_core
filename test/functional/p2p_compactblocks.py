...
# TestP2PConn: A peer we use to send messages to bitcoinsilverd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes bitcoinsilverd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinsilverd's choice of nonce.
    ...
    # Test that bitcoinsilverd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinsilverd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitcoinsilverd will not send blocktxn responses for blocks whose height is
