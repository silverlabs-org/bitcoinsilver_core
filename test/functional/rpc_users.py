...
class HTTPBasicsTest(Bitcoin_SilverTestFramework):
    ...
    def setup_chain(self):
        super().setup_chain()
        #Append rpcauth to bitcoin_silver.conf before initialization
        ...
        with open(os.path.join(get_datadir_path(self.options.tmpdir, 0), "bitcoin_silver.conf"), 'a', encoding='utf8') as f:
            ...
            f.write(rpcauth2 + "\n")
            f.write(rpcauth3 + "\n")
        with open(os.path.join(get_datadir_path(self.options.tmpdir, 1), "bitcoin_silver.conf"), 'a', encoding='utf8') as f:
            f.write("rpcuser={}\n".format(self.rpcuser))
