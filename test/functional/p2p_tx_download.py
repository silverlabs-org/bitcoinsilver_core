...
class TxDownloadTest(Bitcoin_SilverTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new bitcoin_silverd instances, as setting mocktimes has long-term effects on when
