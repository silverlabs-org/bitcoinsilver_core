...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinsilver-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitcoinsilver-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinsilver-cli getwalletinfo return expected wallet info")
            ...
            # Test bitcoinsilver-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoinsilver-cli -generate with -rpcwallet in multiwallet mode.
