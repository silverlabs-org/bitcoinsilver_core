...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Bitcoin_SilverTestFramework
    pass


class ExampleTest(Bitcoin_SilverTestFramework):
    # Each functional test is a subclass of the Bitcoin_SilverTestFramework class.
    ...
    def custom_method(self):
        ...
        Bitcoin_SilverTestFramework class so other tests can use it."""
