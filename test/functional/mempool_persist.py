...
By default, bitcoin_silverd will dump mempool on shutdown and
...
class MempoolPersistTest(Bitcoin_SilverTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoin_silverd from writing mempool.dat to disk. Verify that `savemempool` fails")
