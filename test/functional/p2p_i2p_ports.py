#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Bitcoin_Silver Core developers
...
class I2PPorts(Bitcoin_SilverTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:8383"
        raised = False
        try:
