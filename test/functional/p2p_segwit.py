...
class SegWitTest(Bitcoin_SilverTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older bitcoin_silverd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bitcoin_silverd fill it in.
