...
"""Example logging BitcoinSilver utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitcoinsilverd
...
def main(bitcoinsilverd_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitcoinsilverd_with_usdts])
