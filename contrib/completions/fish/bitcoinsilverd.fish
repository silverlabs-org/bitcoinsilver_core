...
complete --command bitcoinsilverd --no-files

# Extract options
function __fish_bitcoinsilverd_get_options
...
complete \
    --command bitcoinsilverd \
    --arguments "(__fish_bitcoinsilverd_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command bitcoinsilverd \
...
complete \
    --command bitcoinsilverd \
    --arguments "(__fish_bitcoinsilverd_get_options --nofiles)"
