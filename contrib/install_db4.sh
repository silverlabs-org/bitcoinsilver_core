...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoin_silver repository."
  exit 1
fi
...
# See https://github.com/bitcoin_silver/bitcoin_silver/issues/16064
...
echo 'When compiling bitcoin_silverd, run `./configure` in the following way:'
echo
