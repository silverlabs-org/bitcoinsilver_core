...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINSILVER_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINSILVER_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinsilver network\n')
    ...
    g.write('#endif // BITCOINSILVER_CHAINPARAMSSEEDS_H\n')
