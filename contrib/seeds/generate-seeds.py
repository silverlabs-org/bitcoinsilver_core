...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOIN_SILVER_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOIN_SILVER_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoin_silver network\n')
    ...
    g.write('#endif // BITCOIN_SILVER_CHAINPARAMSSEEDS_H\n')
