...
def main():
    ...
    # Filter out hosts with multiple bitcoin_silver ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple bitcoin_silver ports' % (ip_stats(ips)), file=sys.stderr)
