#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Bitcoin_Silver Core developers
...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/bitcoin_silver-core/bitcoin_silver-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['BITCOIN_SILVER_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
        os.environ['BITCOIN_SILVER_VERIFY_COMMITS_ALLOW_REVSIG'] = "1" if current_commit in revsig_allowed else "0"
