...
bitcoin_silvercore.org and bitcoin_silver.org and compares them.
...
WORKINGDIR = "/tmp/bitcoin_silver_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://bitcoin_silvercore.org"
HOST2 = "https://bitcoin_silver.org"
VERSIONPREFIX = "bitcoin_silver-core-"
...
def main(args):
    ...
    if not success:
        print("bitcoin_silver.org failed to provide signature file, "
              "but bitcoin_silvercore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bitcoin_silver.org and bitcoin_silvercore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Bitcoin_Silver Core binary release "
