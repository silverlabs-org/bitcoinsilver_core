...
(define* (make-bitcoin_silver-cross-toolchain target
                                       #:key
...
desirable for building Bitcoin_Silver Core release binaries."
...
(define glibc-2.27/bitcoin_silver-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-bitcoin_silver-cross-toolchain target
                                                      #:base-libc glibc-2.27/bitcoin_silver-patched
