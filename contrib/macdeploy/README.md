...
When complete, it will have produced `Bitcoin_Silver-Core.dmg`.
...
apt install cpio
git clone https://github.com/bitcoin_silver-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/bitcoin_silver-core/bitcoin_silver-detached-sigs).
