...
export CONTAINER_NAME=ci_native_nowallet_libbitcoinsilverkernel
...
export GOAL="install"
export BITCOINSILVER_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
