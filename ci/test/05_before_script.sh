...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Bitcoin_Silver
else
  DOCKER_EXEC echo \> \$HOME/.bitcoin_silver
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitcoin_silver/bitcoin_silver/pull/18288#discussion_r433189350 for
  # details.
