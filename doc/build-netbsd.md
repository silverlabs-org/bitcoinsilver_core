...
This guide describes how to build bitcoinsilverd, command-line utilities, and GUI on NetBSD.
...
`sqlite3` is required to enable support for [descriptor wallets](https://github.com/MrVistos/bitcoinsilver/blob/master/doc/descriptors.md).
...
BitcoinSilver includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure BitcoinSilver. Here is an example that
