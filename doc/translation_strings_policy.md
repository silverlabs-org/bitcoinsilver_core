...
This document provides guidelines for internationalization of the Bitcoin_Silver Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoin_silver_en.ts` remains unchanged.
