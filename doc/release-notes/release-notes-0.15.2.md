Bitcoin_Silver Core version *0.15.2* is now available from:

  <https://bitcoin_silvercore.org/bin/bitcoin_silver-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitcoin_silver-tx (TheBlueMatt)
