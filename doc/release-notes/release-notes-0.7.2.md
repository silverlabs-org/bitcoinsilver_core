Bitcoin_Silver version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoin_silver/files/Bitcoin_Silver/bitcoin_silver-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Bitcoin_Silver-Qt to crash on Windows when exiting.
