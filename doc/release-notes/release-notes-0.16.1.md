Bitcoin_Silver Core version 0.16.1 is now available from:

  <https://bitcoin_silvercore.org/bin/bitcoin_silver-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoin_silverd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoin_silverd processes are cleaned up when tests end (sdaftuar)
