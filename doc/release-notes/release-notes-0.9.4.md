Bitcoin_Silver Core version 0.9.4 is now available from:

  https://bitcoin_silver.org/bin/0.9.4/
...
this update is incompatible with the Bitcoin_Silver system and could lead to consensus
forks.

Bitcoin_Silver Core released binaries from https://bitcoin_silver.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin_silver/+archive/ubuntu/bitcoin_silver
- A third-party or self-compiled Bitcoin_Silver Core

upgrade to Bitcoin_Silver Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
