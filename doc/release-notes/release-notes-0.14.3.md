Bitcoin_Silver Core version *0.14.3* is now available from:

  <https://bitcoin_silver.org/bin/bitcoin_silver-core-0.14.3/>
...
Bitcoin_Silver Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/bitcoin_silverd.openrcconf: Don't disable wallet by default (Luke Dashjr)
