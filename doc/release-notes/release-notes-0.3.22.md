Download URL: https://sourceforge.net/projects/bitcoin_silver/files/Bitcoin_Silver/bitcoin_silver-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCS fee schedule (users still pay 0.01 BTCS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoin_silver00 - #bitcoin_silver99
