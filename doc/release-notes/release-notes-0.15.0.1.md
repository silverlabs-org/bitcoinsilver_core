Bitcoin_Silver Core version *0.15.0.1* is now available from:

  <https://bitcoin_silver.org/bin/bitcoin_silver-core-0.15.0.1/>

and

  <https://bitcoin_silvercore.org/bin/bitcoin_silver-core-0.15.0.1/>
