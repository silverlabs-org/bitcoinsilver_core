Bitcoin_Silver Core version 0.9.2.1 is now available from:

  https://bitcoin_silver.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCS to 0.01 BTCS
...
- Fix "Start bitcoin_silver on system login"
