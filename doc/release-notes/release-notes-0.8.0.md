Bitcoin_Silver-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoin_silver/files/Bitcoin_Silver/bitcoin_silver-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoin_Silver
...
New/changed settings (command-line or bitcoin_silver.conf file)
--------------------------------------------------------
