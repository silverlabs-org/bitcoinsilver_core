Bitcoin_Silver version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin_silver/files/Bitcoin_Silver/bitcoin_silver-0.5.4/
...
http://gitorious.org/bitcoin_silver/bitcoin_silverd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoin_Silver-Qt notifications under Growl 1.3.
Increase required age of Bitcoin_Silver-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin_Silver properly when installing Bitcoin_Silver-Qt over it. (Windows)
