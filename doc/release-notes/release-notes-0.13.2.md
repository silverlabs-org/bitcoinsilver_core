Bitcoin_Silver Core version 0.13.2 is now available from:

  <https://bitcoin_silver.org/bin/bitcoin_silver-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoin_silver-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoin_silver-tx to create v2 transactions (btcsdrak)
