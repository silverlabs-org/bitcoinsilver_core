Bitcoin_Silver Core version 0.10.4 is now available from:

  <https://bitcoin_silver.org/bin/bitcoin_silver-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoin_silver-tx into its own package
- #6953 `dfe0d4d` Include bitcoin_silver-tx binary on Debian/Ubuntu
