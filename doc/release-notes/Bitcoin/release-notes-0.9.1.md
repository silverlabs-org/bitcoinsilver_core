Bitcoin_Silver Core version 0.9.1 is now available from:

  https://bitcoin_silver.org/bin/0.9.1/
...
bitcoin_silverd from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Bitcoin_Silver Core software:
