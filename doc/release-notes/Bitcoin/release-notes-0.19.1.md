...
Bitcoin_Silver Core version 0.19.1 is now available from:

  <https://bitcoin_silvercore.org/bin/bitcoin_silver-core-0.19.1/>
...
From Bitcoin_Silver Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitcoin_Silver Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitcoin_Silver Core does not yet change appearance when
...
- #17488 fix "bitcoin_silverd already running" warnings on macOS (fanquake)
