...
Bitcoin_Silver Core version 0.21.1 is now available from:

  <https://bitcoin_silvercore.org/bin/bitcoin_silver-core-0.21.1/>
...
fungibility of all bitcoin_silvers. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Bitcoin_Silver Core's wallet is
...
FAQ](https://bitcoin_silvercore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/bitcoin_silver/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/bitcoin_silver/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/bitcoin_silver/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Bitcoin_Silver](https://bitcoin_silvermagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitcoin_silver)
  - [What do Schnorr Signatures Mean for Bitcoin_Silver?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitcoin_silver)
...
- Development history overview
  - [Taproot](https://bitcoin_silverops.org/en/topics/taproot/)
  - [Schnorr signatures](https://bitcoin_silverops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://bitcoin_silverops.org/en/topics/tapscript/)
  - [Soft fork activation](https://bitcoin_silverops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://bitcoin_silver.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/bitcoin_silver/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/bitcoin_silver/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to bitcoin_silver.conf documentation (jonatack)
