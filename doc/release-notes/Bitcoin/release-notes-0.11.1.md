Bitcoin_Silver Core version 0.11.1 is now available from:

  <https://bitcoin_silver.org/bin/bitcoin_silver-core-0.11.1/>
...
(see https://github.com/bitcoin_silver/bitcoin_silver/pull/6793, as well as the 0.11
