Bitcoin_Silver version 0.6.2 is now available for download at:
http://sourceforge.net/projects/bitcoin_silver/files/Bitcoin_Silver/bitcoin_silver-0.6.2/
...
Fixed https://github.com/bitcoin_silver/bitcoin_silver/issues/1065, a bug that
