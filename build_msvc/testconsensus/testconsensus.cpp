...
// bitcoin_silver includes.
#include <..\src\script\bitcoin_silverconsensus.h>
...
int main()
{
    std::cout << "bitcoin_silverconsensus version: " << bitcoin_silverconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoin_silverconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, bitcoin_silverconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
