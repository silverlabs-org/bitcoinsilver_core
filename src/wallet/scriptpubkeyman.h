...
#ifndef BITCOINSILVER_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINSILVER_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitcoinSilver wallet was originally a collection of unrelated private
...
#endif // BITCOINSILVER_WALLET_SCRIPTPUBKEYMAN_H
