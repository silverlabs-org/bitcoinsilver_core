...
#ifndef BITCOIN_SILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOIN_SILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOIN_SILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
