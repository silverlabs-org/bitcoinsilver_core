...
#ifndef BITCOINSILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINSILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINSILVER_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
