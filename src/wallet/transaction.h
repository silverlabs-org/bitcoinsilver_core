...
#ifndef BITCOINSILVER_WALLET_TRANSACTION_H
#define BITCOINSILVER_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitcoinsilver node, and set to 0 for transactions that were created
...
#endif // BITCOINSILVER_WALLET_TRANSACTION_H
