...
#ifndef BITCOIN_SILVER_WALLET_TEST_WALLET_TEST_FIXTURE_H
#define BITCOIN_SILVER_WALLET_TEST_WALLET_TEST_FIXTURE_H
...
#endif // BITCOIN_SILVER_WALLET_TEST_WALLET_TEST_FIXTURE_H
