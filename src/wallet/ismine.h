...
#ifndef BITCOIN_SILVER_WALLET_ISMINE_H
#define BITCOIN_SILVER_WALLET_ISMINE_H
 ...
 * https://github.com/bitcoin_silver/bitcoin_silver/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // BITCOIN_SILVER_WALLET_ISMINE_H
