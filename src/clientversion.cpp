 ...
 * for both bitcoin_silverd and bitcoin_silver-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bitcoin_silver/bips/blob/master/bip-0014.mediawiki)
 */
