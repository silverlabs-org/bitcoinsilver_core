...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Αυτές είναι οι Bitcoin_Silver διευθύνσεις σας για να στέλνετε πληρωμές. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη πριν στείλετε νομίσματα.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Αυτές είναι οι Bitcoin_Silver διευθύνσεις για την λήψη πληρωμών. Χρησιμοποιήστε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για την δημιουργία νέας διεύθυνσης.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Προσόχη! Εάν κρυπτογραφήσεις το πορτοφόλι σου και χάσεις τη φράση αποκατάστασης, θα &lt;b&gt; ΧΑΣΕΙΣ ΟΛΑ ΣΟΥ ΤΑ BITCOIN_SILVER &lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα bitcoin_silvers σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Εισάγετε μια διεύθυνση Bitcoin_Silver (π.χ. %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Στείλε νομίσματα σε μια διεύθυνση bitcoin_silver</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Υπογράψτε ένα μήνυμα για ν' αποδείξετε πως ανήκει μια συγκεκριμένη διεύθυνση Bitcoin_Silver</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις bitcoin_silver: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed Bitcoin_Silver</translation>
    </message>
    <message>
        <source>Load Partially Signed Bitcoin_Silver Transaction from clipboard</source>
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed Bitcoin_Silver από το πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε ένα bitcoin_silver: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για Bitcoin_Silver εντολές </translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n ενεργές συνδέσεις στο δίκτυο Bitcoin_Silver.</numerusform>
            <numerusform>%n ενεργές συνδέσεις στο δίκτυο Bitcoin_Silver.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση "%1" δεν είναι έγκυρη Bitcoin_Silver διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ Bitcoin_Silver.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η προσπάθεια να δαπανήσετε bitcoin_silvers που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε το bitcoin_silver URI</translation>
    </message>
    </context>
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Πλήρης διαδρομή ενός script συμβατού με το Bitcoin_Silver Core (π.χ.: C:\Downloads\hwi.exe ή /Users/you/Downloads/hwi.py). Προσοχή: το κακόβουλο λογισμικό μπορεί να κλέψει τα νομίσματά σας!</translation>
    </message>
    <message>
        ...
        <translation>Αυτόματο άνοιγμα των θυρών Bitcoin_Silver στον δρομολογητή. Λειτουργεί μόνο αν ο δρομολογητής σας υποστηρίζει τη λειτουργία UPnP.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε αυτόματα τη πόρτα του Bitcoin_Silver client στο router. Αυτό λειτουργεί μόνο όταν το router σας υποστηρίζει NAT-PMP και είναι ενεργοποιημένο. Η εξωτερική πόρτα μπορεί να είναι τυχαία.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σύνδεση στο δίκτυο Bitcoin_Silver μέσω διαμεσολαβητή SOCKS5 (π.χ. για σύνδεση μέσω Tor)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Συνδεθείτε στο δίκτυο Bitcoin_Silver μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για τις onion υπηρεσίες του Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο Bitcoin_Silver μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Δεν είναι δυνατή η εκκίνηση του bitcoin_silver: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">'bitcoin_silver: //' δεν είναι έγκυρο URI. Χρησιμοποιήστε το "bitcoin_silver:" αντ 'αυτού.</translation>
    </message>
    <message>
        <source>URI cannot be parsed! This can be caused by an invalid Bitcoin_Silver address or malformed URI parameters.</source>
        <translation type="unfinished">Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση Bitcoin_Silver ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου Bitcoin_Silver.</translation>
    </message>
    <message>
...
Σημείωση: Εφόσον η χρέωση υπολογίζεται ανά byte, ένας ρυθμός χρέωσης των «100 satoshis ανά kvB» για μέγεθος συναλλαγής 500 ψηφιακών bytes (το μισό του 1 kvB) θα απέφερε χρέωση μόλις 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές bitcoin_silver από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Παρακαλούμε, ελέγξτε την πρόταση συναλλαγής. Θα παραχθεί μια συναλλαγή Bitcoin_Silver με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Προειδοποίηση: Μη έγκυρη διεύθυνση Bitcoin_Silver</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση Bitcoin_Silver που θα σταλεί η πληρωμή</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα bitcoin_silvers από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα μήνυμα που επισυνάφθηκε στο bitcoin_silver: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου Bitcoin_Silver.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Υπογράψτε το μήνυμα για να αποδείξετε πως σας ανήκει η συγκεκριμένη διεύθυνση Bitcoin_Silver</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
    ...
    <message>
        ...
        <translation type="unfinished">Διεύθυνση Bitcoin_Silver με την οποία έχει υπογραφεί το μήνυμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Επαληθεύστε το μήνυμα για να αποδείξετε πως υπογράφθηκε από τη συγκεκριμένη διεύθυνση Bitcoin_Silver</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Επιβεβαίωση Mηνύματος</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s κατεστραμμένο. Δοκιμάστε να το επισκευάσετε με το εργαλείο πορτοφολιού bitcoin_silver-wallet, ή επαναφέρετε κάποιο αντίγραφο ασφαλείας.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σφάλμα: Η έκδοση του αρχείου dump δεν υποστηρίζεται. Αυτή η έκδοση του bitcoin_silver-wallet υποστηρίζει αρχεία dump μόνο της έκδοσης 1. Δόθηκε αρχείο dump έκδοσης %s.</translation>
    </message>
    <message>
