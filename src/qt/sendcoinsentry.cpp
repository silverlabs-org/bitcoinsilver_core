    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitcoin_silver address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitcoin_silver address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &Bitcoin_SilverAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
