    ...
    mapper(nullptr)
{
    ...
    ui->bitcoin_silverAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoin_silverAtStartup);
    ...
    ui->bitcoin_silverAtStartup->setToolTip(ui->bitcoin_silverAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoin_silverAtStartup->setText(ui->bitcoin_silverAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoin_SilverConfButton->setToolTip(ui->openBitcoin_SilverConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new Bitcoin_SilverUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoin_silverAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoin_SilverConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoin_SilverConf())
