...
#ifndef BITCOINSILVER_QT_WALLETVIEW_H
#define BITCOINSILVER_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a bitcoinsilver wallet, and offers access to
...
#endif // BITCOINSILVER_QT_WALLETVIEW_H
