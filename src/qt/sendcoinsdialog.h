...
#ifndef BITCOIN_SILVER_QT_SENDCOINSDIALOG_H
#define BITCOIN_SILVER_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoin_silvers */
...
#endif // BITCOIN_SILVER_QT_SENDCOINSDIALOG_H
