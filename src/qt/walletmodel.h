...
#ifndef BITCOIN_SILVER_QT_WALLETMODEL_H
#define BITCOIN_SILVER_QT_WALLETMODEL_H
...
/** Interface to Bitcoin_Silver wallet from Qt view code. */
...
#endif // BITCOIN_SILVER_QT_WALLETMODEL_H
