...
#ifndef BITCOIN_SILVER_INTERFACES_INIT_H
#define BITCOIN_SILVER_INTERFACES_INIT_H
...
//! (bitcoin_silver-gui, bitcoin_silver-node, bitcoin_silver-wallet, bitcoin_silverd, bitcoin_silver-qt) and each
...
#endif // BITCOIN_SILVER_INTERFACES_INIT_H
