...
#ifndef BITCOIN_SILVER_INTERFACES_NODE_H
#define BITCOIN_SILVER_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoin_silver node (bitcoin_silverd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOIN_SILVER_INTERFACES_NODE_H
