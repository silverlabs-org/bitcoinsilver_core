...
#ifndef BITCOINSILVER_INTERFACES_NODE_H
#define BITCOINSILVER_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinsilver node (bitcoinsilverd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bitcoinsilver.conf.
...
#endif // BITCOINSILVER_INTERFACES_NODE_H
