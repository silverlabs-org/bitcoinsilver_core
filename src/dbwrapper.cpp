    ...
    void Logv(const char * format, va_list ap) override {
            ...
            for (int iter = 0; iter < 2; iter++) {
                ...
                if (p < limit) {
                    ...
                    // Do not use vsnprintf elsewhere in bitcoinsilver source code, see above.
                ...
                LogPrintLevel(BCLog::LEVELDB, BCLog::Level::Debug, "%s", base); // NOLINT(bitcoinsilver-unterminated-logprintf)
                if (base != buffer) {
                    delete[] base;
                }
                break;
