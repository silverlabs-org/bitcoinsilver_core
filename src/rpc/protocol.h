...
#ifndef BITCOIN_SILVER_RPC_PROTOCOL_H
#define BITCOIN_SILVER_RPC_PROTOCOL_H
...
//! Bitcoin_Silver RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoin_silverd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bitcoin_Silver is not connected
...
#endif // BITCOIN_SILVER_RPC_PROTOCOL_H
