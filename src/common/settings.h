...
#ifndef BITCOINSILVER_COMMON_SETTINGS_H
#define BITCOINSILVER_COMMON_SETTINGS_H
...
//!       https://github.com/MrVistos/bitcoinsilver/pull/15934/files#r337691812)
...
#endif // BITCOINSILVER_COMMON_SETTINGS_H
