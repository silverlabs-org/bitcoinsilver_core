...
#ifndef BITCOIN_SILVER_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOIN_SILVER_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoin_silver.
 *
 ...
 *
 * The chacha20-poly1305@bitcoin_silver combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoin_silver cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoin_silver are relatively fast in
...
#endif // BITCOIN_SILVER_CRYPTO_CHACHA_POLY_AEAD_H
