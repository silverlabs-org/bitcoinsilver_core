...
#ifndef BITCOINSILVER_PROTOCOL_H
#define BITCOINSILVER_PROTOCOL_H
...
/**
 * BitcoinSilver protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all BitcoinSilver non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // bitcoinsilver-development mailing list. Remember that service bits are just
...
#endif // BITCOINSILVER_PROTOCOL_H
