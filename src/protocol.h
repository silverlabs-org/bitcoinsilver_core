...
#ifndef BITCOIN_SILVER_PROTOCOL_H
#define BITCOIN_SILVER_PROTOCOL_H
...
/**
 * Bitcoin_Silver protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Bitcoin_Silver Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Bitcoin_Silver Core nodes used to support this by default, without advertising this bit,
    ...
    // bitcoin_silver-development mailing list. Remember that service bits are just
...
#endif // BITCOIN_SILVER_PROTOCOL_H
