// Copyright (c) 2015-2018 The Bitcoin_Silver Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOIN_SILVER_CORE_MEMUSAGE_H
#define BITCOIN_SILVER_CORE_MEMUSAGE_H
...
#endif // BITCOIN_SILVER_CORE_MEMUSAGE_H
