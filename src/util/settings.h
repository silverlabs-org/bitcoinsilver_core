...
#ifndef BITCOIN_SILVER_UTIL_SETTINGS_H
#define BITCOIN_SILVER_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoin_silver/bitcoin_silver/pull/15934/files#r337691812)
...
#endif // BITCOIN_SILVER_UTIL_SETTINGS_H
