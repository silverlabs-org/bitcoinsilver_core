...
#ifndef BITCOINSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
#define BITCOINSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // BITCOINSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
