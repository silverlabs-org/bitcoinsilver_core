...
#ifndef BITCOINSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define BITCOINSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // BITCOINSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
