...
#ifndef BITCOINSILVER_KERNEL_CONTEXT_H
#define BITCOINSILVER_KERNEL_CONTEXT_H
...
//! passed to external libbitcoinsilver_kernel functions which need access to this
...
#endif // BITCOINSILVER_KERNEL_CONTEXT_H
