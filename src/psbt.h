...
#ifndef BITCOIN_SILVER_PSBT_H
#define BITCOIN_SILVER_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Bitcoin_Silver transaction.) Returns true if the merge succeeded, false otherwise. */
