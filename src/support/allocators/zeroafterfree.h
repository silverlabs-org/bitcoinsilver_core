...
#ifndef BITCOIN_SILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOIN_SILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOIN_SILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
