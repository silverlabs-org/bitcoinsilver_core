...
#ifndef BITCOINSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
