...
#ifndef BITCOIN_SILVER_TEST_SCRIPTNUM10_H
#define BITCOIN_SILVER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoin_Silver Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOIN_SILVER_TEST_BIGNUM_H
