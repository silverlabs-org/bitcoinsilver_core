...
#ifndef BITCOIN_SILVER_TEST_UTIL_TRANSACTION_UTILS_H
#define BITCOIN_SILVER_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BITCOIN_SILVER_TEST_UTIL_TRANSACTION_UTILS_H
