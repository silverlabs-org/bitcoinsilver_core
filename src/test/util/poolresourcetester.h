...
#ifndef BITCOINSILVER_TEST_UTIL_POOLRESOURCETESTER_H
#define BITCOINSILVER_TEST_UTIL_POOLRESOURCETESTER_H
...
#endif // BITCOINSILVER_TEST_UTIL_POOLRESOURCETESTER_H
