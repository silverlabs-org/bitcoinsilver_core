...
#ifndef BITCOIN_SILVER_SCRIPT_STANDARD_H
#define BITCOIN_SILVER_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitcoin_silver address
 */
...
/**
 * Generate a Bitcoin_Silver scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITCOIN_SILVER_SCRIPT_STANDARD_H
