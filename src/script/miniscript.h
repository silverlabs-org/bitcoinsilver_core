...
#ifndef BITCOINSILVER_SCRIPT_MINISCRIPT_H
#define BITCOINSILVER_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bitcoinsilver script
...
#endif // BITCOINSILVER_SCRIPT_MINISCRIPT_H
