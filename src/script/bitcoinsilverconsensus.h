...
#ifndef BITCOINSILVER_SCRIPT_BITCOINSILVERCONSENSUS_H
#define BITCOINSILVER_SCRIPT_BITCOINSILVERCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_BITCOINSILVER_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/bitcoinsilver-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBBITCOINSILVERCONSENSUS)
...
#endif // BITCOINSILVER_SCRIPT_BITCOINSILVERCONSENSUS_H
