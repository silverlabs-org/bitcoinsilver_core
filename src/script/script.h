...
#ifndef BITCOINSILVER_SCRIPT_SCRIPT_H
#define BITCOINSILVER_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinSilver always counted CHECKMULTISIGs
...
#endif // BITCOINSILVER_SCRIPT_SCRIPT_H
