...
#ifndef BITCOIN_SILVER_SCRIPT_SCRIPT_H
#define BITCOIN_SILVER_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Bitcoin_Silver always counted CHECKMULTISIGs
...
#endif // BITCOIN_SILVER_SCRIPT_SCRIPT_H
