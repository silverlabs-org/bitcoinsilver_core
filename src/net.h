...
#ifndef BITCOIN_SILVER_NET_H
#define BITCOIN_SILVER_NET_H
 ...
 * src/qt/guiutil.cpp and src/bitcoin_silver-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bitcoin_Silver’s Peer-to-Peer Network")
